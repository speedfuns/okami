 ...
 * @property {string[]} types - Tags a challenge to categories it belongs to. First
...
const challengePool = [];
challengePool[0] = [
  { name: "Kamiki Turnip Digging", types: ["sidequest"] },
],
challengePool[1] = [
  { name: "Rejuvenate Mrs. Orange\'s Laundry Poles", types: ["sidequest"] },
...
challengePool[24] = [
 { name: "Defeat the Kamui Devil Gate Bandit Spider", types: ["boss"] },
